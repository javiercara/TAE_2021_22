...
1. Modelo de regresión logística
    ...
    c. [Regresión logística binomial](logit_modelo_binomial.html) [(pdf)](logit_modelo_binomial.pdf)
...
1. Modelo de regresión logística
    a. [Modelo](poisson_modelo_.html) [(pdf)](poisson_modelo.pdf)
2. Inferencia en el modelo de regresión logística
...
4. Bondad de ajuste
    a. Bondad del ajuste (No entra en el examen)
