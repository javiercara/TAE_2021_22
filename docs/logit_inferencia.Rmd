...
$$
es decir, la inversa del hessiano de la función de verosimilitud (con signo negativo). En el caso de la propiedad anterior, la matriz $I(\beta)$ está evaluada en el valor que maximiza la verosimilitud. Por tanto, cada estimador de manera individual se distribuye como:
...
mle = optim(par = beta_i, fn = logL_optim, gr = NULL,
  y = d$InMichelin, X = X, 
...
Esta información se aporta cuando utilizamos la funcion glm():
