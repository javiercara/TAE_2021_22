...
Como $\beta_1 > 0$ quiere decir que P(Approve|Homeowner = N) < P(Approve|Homeowner = Y).
...
En el fondo estamos estimando P(Reject|Homeowner = "Y"), ya que
